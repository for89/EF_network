...
(iter = 12,000; burn-in = 6,000; 4 chains). For each cohort-wave model,
we extracted posterior draws of the 3×3 partial-correlation matrix and
summarized each edge using the posterior median and 95\% credible
...
P(\textbar r\textbar{} \textgreater{} 0.1) = 0.996; T2: median r = 0.31,
95\% CrI {[}0.18, 0.43{]}, P(\textbar r\textbar{} \textgreater{} 0.1) =
0.999; T3: median r = 0.30, 95\% CrI {[}0.11, 0.47{]},
P(\textbar r\textbar{} \textgreater{} 0.1) = 0.982) and met the
...
at T1 (median r = 0.26, 95\% CrI {[}0.13, 0.37{]},
P(\textbar r\textbar{} \textgreater{} 0.1) = 0.992) and remained
positive at later waves (T2: median r = 0.19, 95\% CrI {[}0.06, 0.32{]},
P(\textbar r\textbar{} \textgreater{} 0.1) = 0.909; T3: median r = 0.15,
95\% CrI {[}-0.04, 0.34{]}, P(\textbar r\textbar{} \textgreater{} 0.1) =
0.720), but did not consistently exceed the meaningfulness threshold at
...
T2: median r = 0.15, 95\% CrI {[}0.02, 0.28{]}, P(\textbar r\textbar{}
\textgreater{} 0.1) = 0.764; T3: median r = 0.18, 95\% CrI {[}-0.01,
0.36{]}, P(\textbar r\textbar{} \textgreater{} 0.1) = 0.807).
...
P(\textbar r\textbar{} \textgreater{} 0.1) = 0.911, median r = 0.15,
95\% CrI {[}0.01, 0.28{]}, P(\textbar r\textbar{} \textgreater{} 0.1) =
0.768, median r = 0.13, 95\% CrI {[}-0.01, 0.26{]},
P(\textbar r\textbar{} \textgreater{} 0.1) = 0.645; T2: median r = 0.10,
95\% CrI {[}-0.05, 0.24{]}, P(\textbar r\textbar{} \textgreater{} 0.1) =
0.517, median r = 0.19, 95\% CrI {[}0.04, 0.32{]},
P(\textbar r\textbar{} \textgreater{} 0.1) = 0.884, median r = 0.11,
95\% CrI {[}-0.03, 0.25{]}, P(\textbar r\textbar{} \textgreater{} 0.1) =
0.564). However, no South Africa edge met the meaningfulness criterion
...
within-wave coupling under the preregistered ROPE decision rule.
